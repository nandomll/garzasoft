<%-- 
    Document   : admi-trabajador
    Created on : 14/03/2022, 08:44:44 PM
    Author     : hp
--%>
...
<html>
 <head>
    ...
    <body>
        ...
        <div class=" contenido pl-2 pr-2 pt-4 pb-2"> 
          <div class=" d-inline h4 ma-1 pl-2 "><i class="fas fa-user"></i> Lista de Trabajadores 
             </div>     
                      ...
                      <tbody>
                       <c:forEach var="tra" items="${t}"> 
                        <tr class="pb-5">
                          ...
                          <td >${tra.getCorreo()}</td>
                          <td >${tra.getCondicion()}</td>
                        
                          <td  >
                          <!--boton actualizar-->
                           <a class="btn btn-warning text-white " style="font-size: 15px" id="actualizar" data-toggle="modal" data-target="#nuevo2${tra.getIdtrabajador()}"><i class="fas fa-edit"></i></a>  
                         <!--boton actualizar--> 
                        
                        <!--modal actualizar-->  
                             <div class="modal fade" id="nuevo2${tra.getIdtrabajador()}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  ...
                                  <form  action="controladoradministrador" method="post" novalidate>
                                      <input type="hidden" name="idtrabajador" value="${tra.getIdtrabajador()}">
                                        ...
                                        <div class="form-group col-md-6">
                                          ...
                                          <div class="input-group">
                                            <div class="input-group-prepend">
                                              ...
                                              <input type="text" class="form-control"  name="dni1" value="${tra.getDni()}">
                                          </div>
                                        </div>
                                         <div class="form-group col-md-6">
                                          ...
                                          <div class="input-group">
                                            <div class="input-group-prepend">
                                              ...
                                              <input type="text" class="form-control"  name="nombre1" value="${tra.getNombre()}">
                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                          ...
                                          <div class="input-group">
                                            <div class="input-group-prepend">
                                              ...
                                              <input type="text" class="form-control"  name="apellido1" value="${tra.getApellido()}">
                                          </div>
                                        </div>  
                                          <div class="form-group col-md-6">
                                          ...
                                          <div class="input-group">
                                            <div class="input-group-prepend">
                                              ...
                                              <input type="text" class="form-control"  name="telefono1" value="${tra.getTelefono()}">
                                          </div>
                                        </div> 
                                      </div>
                                       <div class="form-row">  
                                          ...
                                          <label for="inputtext">Genero</label>
                                           <div class="input-group">
                                            ...
                                            <select class="form-control" name="genero1" >
                                                <option value=""<c:if test="${tra.getSexo()==''}">selected</c:if> >Seleccione...</option>
                                                <option value="hombre"<c:if test="${tra.getSexo()=='hombre'}">selected</c:if> >Hombre</option>
                                                <option value="mujer"<c:if test="${tra.getSexo()=='mujer'}">selected</c:if> >Mujer</option>
                                        ...
                                        <div class="form-group col-md-6">
                                          ...
                                          <div class="input-group">
                                            <div class="input-group-prepend">
                                              ...
                                              <input type="text" class="form-control calen" name="fecha1" value="${tra.getIngreso()}" >
                                          </div>
                                        </div>
                                       ...
                                       <div class="form-group col-md-6">
                                          ...
                                          <div class="input-group">
                                            <div class="input-group-prepend">
                                              ...
                                              <input type="password" class="form-control"  name="clave3" value="${tra.getClave()}">
                                          </div>
                                        </div> 
                                        ...
                                        <div class="form-group col-md-6">
                                          ...
                                          <div class="input-group">
                                            <div class="input-group-prepend">
                                              ...
                                              <input type="password" class="form-control"  name="clave4" value="${tra.getClave()}">
                                          </div>
                                        </div> 
                                      </div>    
                                          ...
                                          <div class="input-group">
                                            <div class="input-group-prepend">
                                              ...
                                              <input type="email" class="form-control"  name="correo1" value="${tra.getCorreo()}">
                                          </div>


                                      <button type="submit" name="accion" value="modificartrabajador" class="btn  btn-block mt-4 mb-4 btn-1 text-white" >Actualizar</button>
                        ...
                        <!--modal  actualizar-->  
                           ...
                           <input type="hidden" id="idtrabajador" value="${tra.getIdtrabajador()}">  
                           <a href="#" class="btn btn-danger text-white" id="btndelete"  style="font-size: 15px"><i class="fas fa-trash-alt"></i></a>
                           
                            <c:choose>
                                <c:when test="${tra.getEstado()=='libre'}">
                                    <input type="hidden" id="idtrab" value="${tra.getIdtrabajador() }">
                                    <input type="hidden" id="estado" value="${tra.getEstado()}">
                                   <a href="#" class="btn btn-success text-white" id="btnmodificar" style="font-size: 15px;width: 85px">  Libre</a>
                                </c:when>
                                <c:otherwise>
                                    <input type="hidden" id="idtrab" value="${tra.getIdtrabajador() }">
                                    <input type="hidden" id="estado" value="${tra.getEstado()}">
                                    <a href="#" class="btn btn-primary text-white " id="btnmodificar" style="font-size: 15px">  Ocupado</a> 
                                </c:otherwise>
                            </c:choose>
                        </td>
                        </tr>
                ...
                <div class="modal-dialog" role="document">
                  ...
                  <form  action="controladoradministrador" method="post" novalidate>
                    <div class="modal-body mr-2  mb-2 ml-2">
                      ...
                      <button type="submit" name="accion" value="agregartrabajador" class="btn  btn-block mt-4 mb-4 btn-1 text-white" >Registrar</button>
             ...
             <div class="modal-body pl-3 pr-3 pt-1">
              <form  action="controladorreportes" method="post" novalidate>
                <div class="modal-body mr-1  mb-1 ml-1">
                   ...
                   <button type="submit" name="accion" value="reporte2" class="btn  btn-block mt-4 mb-2 btn-1 text-white" >Generar Reporte</button>
    ...
    <script src="https://kit.fontawesome.com/ef7654b222.js" crossorigin="anonymous"></script> 
     ...
     <script src="js/modificarestado.js" type="text/javascript"></script>
     <script src="js/mensajescrud.js" type="text/javascript"></script>
     <script src="js/deletetrabajador.js" type="text/javascript"></script>
</html>
