<%-- 
    Document   : admi-psoportemodificar
    Created on : 18/03/2022, 09:34:24 AM
    Author     : hp
--%>
...
<html>
    ...
    <body>
        ...
        <div class=" contenido pl-4 pr-4 pt-4 pb-2 "> 
          <div class="h4 ma-1 d-inline pl-2 "><i class="las la-folder-open"></i> Proyectos de Soporte </div>
          <button type="button"  class="btn text-white float-right   btn-danger " data-toggle="modal" data-target="#nuevo5" >
            ...
            <div class="card">
              <div class="card-body pl-4 pr-4 pt-5 pb-4">
                  <form action="controladoradministrador" class="needs-validation mb-5" method="post" novalidate>
                      <input type="hidden" name="idproyecto" value="${unsoporte.getIdproyecto()}">
                      <div class="form-row">
                        <div class="col-md-4 mb-3">
                          ...
                          <div class="input-group">
                            <div class="input-group-prepend">
                              ...
                              <input type="text" class="form-control" name="proyecto" id="validationCustomUsername" value="${unsoporte.getNombre()}" aria-describedby="inputGroupPrepend" required>
                        ...
                        <div class="col-md-4 mb-3">
                          ...
                          <div class="input-group">
                            <div class="input-group-prepend">
                              ...
                              <input type="text" id="calen"  class="form-control calen" name="fechainicio" value="${unsoporte. getInicio()}" required>
                        ...
                        <div class="col-md-4 mb-3">
                          ...
                          <div class="input-group">
                            <div class="input-group-prepend">
                              ...
                              <input type="text" class="form-control calen"  name="fechafin" value="${unsoporte.getFin()}" required>
                          ...
                          <div class="input-group">
                            <div class="input-group-prepend">
                             <span class="input-group-text"  style="font-size: 25px"><i class="las la-user"></i></span>
                              ...
                              <input type="hidden" id="idcliente" name="idcliente" value="${unsoporte.getIdcliente().getIdcliente()}">  
                              <input type="text" class="form-control" id="clientee" value="${unsoporte.getIdcliente().getNombrecli()} ${unsoporte.getIdcliente().getApellidocli()}"  data-toggle="modal" data-target="#nuevo4" required>
                        ...
                        <div class="col-md-6 mb-3">
                          ...
                          <div class="input-group">
                            <div class="input-group-prepend">
                              ...
                              <input type="hidden" id="idtrabajador" name="idtrabajador" value="${unsoporte.getIdtrabajador().getIdtrabajador()}">
                             <input type="text" class="form-control" id="trabajadorr" value="${unsoporte.getIdtrabajador().getNombre()} ${unsoporte.getIdtrabajador().getApellido()}"  data-toggle="modal" data-target="#nuevo3" required>
                            
                          </div>
                        </div>
                      </div>
                    <div class="mt-3 d-flex">
                      <button name="accion" value="modificarsoporte" class="btn btn-warning  mr-1 text-white " type="submit" style="width: 38vw">Modificar</button>
                      <button class="btn btn-danger text-white" name="accion" value="listarsoportes" type="submit" style="width: 37vw">Cancelar</button>
                     </div>
                </form>
                  ...
                  <table class="table  nowrap " id="datatable" style="width:100%" >
                      ...
                      <tbody>
                       <c:forEach var="s" items="${so}">  
                        <tr >
                            <td  >
                              <a href="controladoradministrador?accion=capturarsoporte&idproyecto=${s.getIdproyecto()}" class="btn btn-warning text-white " style="font-size: 15px" id="actualizar" ><i class="fas fa-edit"></i></a> 
                              <input type="hidden" id="idproyecto" value="${s.getIdproyecto()}"> 
                              <a href="#" id="btndelete" class="btn btn-danger text-white  "style="font-size: 15px"><i class="fas fa-trash-alt"></i></a>
                            </td>
                          <c:choose>
                          ...
                          <td>${s.getInicio()}</td>
                          <td>${s.getFin()}</td>
                          <td>${s.getIdcliente().getNombrecli()} ${s.getIdcliente().getApellidocli()}</td>
             ...
             <div class="modal-body pl-3 pr-3 pt-1">
              <form  action="controladorreportes" method="post" target="_blank" novalidate>
                <div class="modal-body mr-1  mb-1 ml-1">
                   ...
                   <button type="submit" name="accion" value="reporte3" class="btn  btn-block mt-4 mb-2 btn-1 text-white" >Generar Reporte</button>
    ...
    <script src="https://kit.fontawesome.com/ef7654b222.js" crossorigin="anonymous"></script> 
     ...
     <script src="js/deleteproyectosoporte.js" type="text/javascript"></script>
