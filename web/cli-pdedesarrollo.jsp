<%-- 
    Document   : cli-pdedesarrollo
    Created on : 28/03/2022, 04:38:18 PM
    Author     : hp
--%>
                       ...
                       <c:forEach var="d" items="${de}">  
                        <tr >  
                          ...
                          <td>${d.getIdtrabajador().getNombre()} ${d.getIdtrabajador().getApellido()}</td>
                           <c:choose>
                            <c:when test="${d.getMantenimiento() == 'no'}">
                               <td >
                                 Nuevo
                              </td>
                            </c:when>
                            <c:when test="${d.getMantenimiento() == 'si'}">
                              <td >
                                  Mantenimiento
                              </td>
                            </c:when>
                         ...
                         <td class="m-0  p-1">                   
                            <a href="controladorcliente?accion=listarrequerimientos&idproyecto=${d.getIdproyecto()}" class="btn  text-white  btn-1  "style="font-size: 15px"><i class="fa-solid fa-list"></i></a> 
