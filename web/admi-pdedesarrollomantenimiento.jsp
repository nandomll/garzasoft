<%-- 
    Document   : admi-pdedesarrollomantenimiento
    Created on : 13/04/2022, 10:32:09 PM
    Author     : hp
--%>
                      ...
                      <div class="form-row">
                        <div class="col-md-4 mb-3">
                          ...
                          <div class="input-group">
                            <div class="input-group-prepend">
                              ...
                              <input type="text" class="form-control" name="proyecto" id="proyectoo" placeholder="Ingrese Proyecto" data-toggle="modal" data-target="#nuevo4"  required>
                        ...
                        <div class="col-md-4 mb-3">
                          ...
                          <div class="input-group">
                            <div class="input-group-prepend">
                              ...
                              <input type="text" id="calen"  class="form-control calen" name="fechainicio" placeholder="aaaa / mm/ dd" required>
                        ...
                        <div class="col-md-4 mb-3">
                          ...
                          <div class="input-group">
                            <div class="input-group-prepend">
                              ...
                              <input type="text" class="form-control calen"  name="fechafin" placeholder="aaaa / mm/ dd" required>
                        ...
                        <div class="col-md-6 mb-3">
                          ...
                          <div class="input-group">
                            <div class="input-group-prepend">
                             ...
                             <input type="text" class="form-control" id="clientee" placeholder="Ingrese Cliente"  readonly  required>
                        ...
                        <div class="col-md-6 mb-3">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="trabajadorr" placeholder="Ingrese Trabajador"  data-toggle="modal" data-target="#nuevo3" required>
                            
                          </div>
                        </div>
                      </div>
                    <div class="mt-3 d-flex">
                      <button name="accion" value="agregarmantenimiento" class="btn btn-1 mr-1 text-white " type="submit" style="width: 38vw">Agregar</button>
                      <button class="btn btn-danger text-white" type="submit" name="accion" value="listardesarrollo" style="width: 37vw">Cancelar</button>
                     </div>
                </form>
