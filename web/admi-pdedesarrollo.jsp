<%-- 
    Document   : admi-pdedesarrollo
    Created on : 19/03/2022, 09:12:33 PM
    Author     : hp
--%>
...
<html>
    ...
    <body>
        ...
        <div class=" contenido pl-4 pr-4 pt-4 pb-2"> 
          <div class=" d-inline h4 ma-1 pl-2 "><i class="las la-folder-open"></i> Proyectos de Desarrollo 
             </div>
             ...
             <div class="card " style=" " >
              <div class="card-body pl-4 pr-4 pt-5 pb-4">
                    ...
                    <div class="mt-3 d-flex">
                      <button name="accion" value="agregardesarrollo" class="btn btn-1 mr-1 text-white " type="submit" style="width: 38vw">Agregar</button>
