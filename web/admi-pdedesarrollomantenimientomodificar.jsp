<%-- 
    Document   : admi-pdedesarrollomantenimientomodificar
    Created on : 14/04/2022, 07:37:56 AM
    Author     : hp
--%>
   ...
   <head>
    ...
    <body>
        ...
        <div class=" contenido pl-4 pr-4 pt-4 pb-2"> 
          <div class=" d-inline h4 ma-1 pl-2 "><i class="las la-folder-open"></i> Proyectos de Desarrollo en Mantenimiento
             </div>  
                      ...
                      <div class="form-row">
                        <div class="col-md-4 mb-3">
                          ...
                          <div class="input-group">
                            <div class="input-group-prepend">
                              ...
                              <input type="text" class="form-control" name="proyecto" value="${undesarrollo.getNombre()}" id="proyectoo" placeholder="Ingrese Proyecto" data-toggle="modal" data-target="#nuevo4"  required>
                        ...
                        <div class="col-md-4 mb-3">
                          ...
                          <div class="input-group">
                            <div class="input-group-prepend">
                              ...
                              <input type="text" id="calen"  class="form-control calen" value="${undesarrollo. getInicio()}" name="fechainicio" placeholder="aaaa / mm/ dd" required>
                        ...
                        <div class="col-md-4 mb-3">
                          ...
                          <div class="input-group">
                            <div class="input-group-prepend">
                              ...
                              <input type="text" class="form-control calen"  name="fechafin" value="${undesarrollo.getFin()}" placeholder="aaaa / mm/ dd" required>
                        ...
                        <div class="col-md-6 mb-3">
                          ...
                          <div class="input-group">
                            <div class="input-group-prepend">
                             ...
                             <input type="text" class="form-control" id="clientee" value="${undesarrollo.getIdcliente().getNombrecli()} ${undesarrollo.getIdcliente().getApellidocli()}" placeholder="Ingrese Cliente"  readonly  required>
                        ...
                        <div class="col-md-6 mb-3">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="trabajadorr" placeholder="Ingrese Trabajador" value="${undesarrollo.getIdtrabajador().getNombre()} ${undesarrollo.getIdtrabajador().getApellido()}" data-toggle="modal" data-target="#nuevo3" required>
                            
                          </div>
                        </div>
                      </div>
                    <div class="mt-3 d-flex">
                      <button name="accion" value="modificarcarmantenimiento" class="btn bg-warning mr-1 text-white " type="submit" style="width: 38vw">Modificar</button>
                      <button class="btn btn-danger text-white" type="submit" name="accion" value="listarmantenimientos" style="width: 37vw">Cancelar</button>
                     </div>
                </form>
                ...
                <table id="datatable" class="table nowrap " style="width:100%">
                       ...
                       <c:forEach var="d" items="${de}">  
                        <tr >
                            <td> 
                              ...
                              <a href="controladoradministrador?accion=capturarmantenimiento&idproyecto=${d.getIdproyecto()}" class="btn btn-warning text-white " style="font-size: 15px" id="actualizar" ><i class="fas fa-edit"></i></a> 
                              <input type="hidden" id="idproyecto1" value="${d.getIdproyecto()}"> 
                              <a href="#" id="btndelete1" class="btn btn-danger text-white "style="font-size: 15px"><i class="fas fa-trash-alt"></i></a> 
                              <a href="controladoradministrador?accion=listarrequerimientos&idproyecto=${d.getIdproyecto()}" class="btn  text-white  btn-1 "style="font-size: 15px"><i class="fa-solid fa-list"></i></a>
                                <c:choose>
                                     <c:when test="${d.getCondicion()=='no'}">
                                        <a href="controladoradministrador?accion=requerimientos2&condicion=${d.getCondicion()}&idproyecto=${d.getIdproyecto()}&estado=${d.getEstado()}" class="btn  text-white  btn-primary"style="font-size: 15px; width: 52px "><i class="fa-solid fa-x"></i></a>
                                     </c:when>
                                    
                                     <c:otherwise>
                                         <a href="controladoradministrador?accion=requerimientos2&condicion=${d.getCondicion()}&idproyecto=${d.getIdproyecto()}&estado=${d.getEstado()}" class="btn  text-white  btn-success "style="font-size: 15px; width: 52px "><i class="fa-solid fa-check"></i></a>
                                     </c:otherwise>
                                </c:choose>
                 ...
                 <!--modal del Cliente--> 
                   <div class="modal fade" id="nuevo4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                     <div class="modal-dialog" role="document">
                       <div class="modal-content mr-4  pl-3 pr-3 pb-4" style="width: 580px">
                         <div class="modal-header mod-h ">
                           <h4 class="modal-title p-0  mt-2 mb-1 ml-3  " id="exampleModalLabel"><i class="fa-solid fa-folder-open"></i> Lista de Proyectos</h4>
                           <div style="border: none" class="close " data-dismiss="modal" aria-label="Close">
                             &times;
                           </div>
                           ...
                           <table class="table m-0" >
                               <thead class="thead-light p-0 m-0 sticky-top">
                                 <tr class="">
                                     ...
                                     <th scope="col" class="w-50" >Proyecto</th>
                                   <th scope="col" >Accion</th> 
                            ...
                            <table class="table m-0" >
                                <tbody class="tablejs" >
                               <c:forEach var="desa" items="${des}"> 
                                 <tr>
                                   <input id="idcl${desa.getIdproyecto()}" type="hidden" value="${desa.getIdcliente().getIdcliente()}">
                               
                                    <td class="w-25" id="dnicl${desa.getIdproyecto()}">${desa.getIdcliente().getDnicli()}</td>
                                    <td class="w-25" id="nomcl${desa.getIdproyecto()}">${desa.getIdcliente().getNombrecli()} ${desa.getIdcliente().getApellidocli()}</td>
                                    <td class="w-50" id="nompr${desa.getIdproyecto()}">${desa. getNombre() }</td>
                                    <td class=" pt-2 text-center">
                                     <a  href="#" onclick="agregarproyecto('${desa.getIdproyecto()}')" style="font-size: 22px; color:green" data-dismiss="modal" aria-label="Close">
                                       <i class="fa-solid fa-circle-plus mr-4"></i> 
                                     </a>  
          ...
          <div class="modal fade" id="nuevo5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
             ...
             <div class="modal-body pl-3 pr-3 pt-1">
              <form  action="controladorreportes" method="post" novalidate>
                <div class="modal-body mr-1  mb-1 ml-1">
                   ...
                   <button type="submit" name="accion" value="reporte5" class="btn  btn-block mt-4 mb-2 btn-1 text-white" >Generar Reporte</button>
           ...
           <input type="hidden" id="idproyecto" value="${msj1}">
    ...
    <script src="https://kit.fontawesome.com/ef7654b222.js" crossorigin="anonymous"></script> 
     ...
     <script src="js/Buscar.js" type="text/javascript"></script>
       <script  type="text/javascript">
          function agregarproyecto(idproyecto){
             ...
             idcliente=document.getElementById("idcl"+idproyecto).value;
             
             nomcliente=document.getElementById("nomcl"+idproyecto).innerHTML;
             nomproyecto=document.getElementById("nompr"+idproyecto).innerHTML;
     
             $("#idcliente").val(idcliente);
             $("#clientee").val(nomcliente);
             $("#proyectoo").val(nomproyecto);
          }
     ...
     <script src="js/deletemantenimiento.js" type="text/javascript"></script>
</html>
