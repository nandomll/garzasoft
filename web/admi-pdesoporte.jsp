<%-- 
    Document   : admi-pdesarrollo
    Created on : 15/03/2022, 07:07:16 AM
    Author     : hp
--%>
              ...
              <div class="card-body pl-4 pr-4 pt-5 pb-4">
                  <form action="controladoradministrador" class="needs-validation mb-5" method="post" novalidate>
                      <div class="form-row">
                        <div class="col-md-4 mb-3">
                          ...
                          <div class="input-group">
                            <div class="input-group-prepend">
                              ...
                              <input type="text" class="form-control" name="proyecto" id="validationCustomUsername" placeholder="Ingrese Proyecto" aria-describedby="inputGroupPrepend" required>
                        ...
                        <div class="col-md-6 mb-3">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="clientee" placeholder="Ingrese Cliente"  data-toggle="modal" data-target="#nuevo4" required>
                    ...
                    <div class="mt-3 d-flex">
                      <button name="accion" value="agregarsoporte" class="btn btn-1 mr-1 text-white " type="submit" style="width: 38vw">Agregar</button>
                      <button class="btn btn-warning text-white" type="reset" style="width: 37vw">Restablecer</button>
                     </div>
                </form>
